...
export const mergeTokens = (source, target, matchProp, addProp) => {
    let result = [...target]
    source.forEach((sourceElement) => {
        let targetElement = result.find((targetElement) => {
            return sourceElement[matchProp] === targetElement[matchProp];
        })
        if (targetElement) {
            targetElement[addProp] += sourceElement[addProp];
        } else {
